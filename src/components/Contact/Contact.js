import { faCheckCircle, faEnvelope, faMapMarkerAlt, faPhoneAlt } from '@fortawesome/free-solid-svg-icons';
...
const Contact = () => {
    ...
    const successConditionSet =()=>setSuccess(false);
    ...
    const onSubmit = ( data,e )=> {
        ...
        .then((result) => {
            if(result.status === 200){
                e.target.reset();
                setSuccess(true);
                setTimeout(successConditionSet,3000);
            }
        }, (error) => {
    ...
    return (
        <div className='pb-5' style={{background:'#ececec9e'}}>
            <div className='container pb-5'>
                ...
                <Row>
                    ...
                    <Form onSubmit={handleSubmit(onSubmit)}>
                        {
                            success && 
                            <div className='text-center' style={{color:'white',background:'#0c0c0cf7',padding:'5px',fontSize:'1.5rem',borderRadius:'4px'}}>
                                <FontAwesomeIcon style={{color:'green',paddingRight:'5px',fontSize:'1.5rem'}} icon={faCheckCircle} />
